    ...
    def analyze(self, observations: list[dict[str, Any]]) -> dict[str, Any]:
        ...
        if len(comments) < 5:
            return {
                ...
                "candidates": [],
                "note": "Mindestens fuenf lokal erfasste Kommentare sind fuer eine Vergleichsbasis erforderlich.",
            }
        ...
        return {
            ...
            "note": "Ausreisser sind Review-Kandidaten, keine Feststellungen zu Absicht, Zugehoerigkeit oder Identitaet.",
        }
