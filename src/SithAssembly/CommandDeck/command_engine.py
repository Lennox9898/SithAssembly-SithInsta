...
class CommandEngine:
    ...
    HELP = {
        "/context": "Show the current local case context.",
        "/find posts --query <text>": "Search local observations.",
        "/find accounts --query <text>": "Search profiles in the active case.",
        "/find mentions @handle": "Show evidenced mentions of an account.",
        "/find links --domain <domain>": "Filter stored shared links.",
        ...
        "/graph common @a @b": "Show common evidence-backed connections.",
        "/graph path @a @b": "Find a directed evidence-backed path in the case graph.",
        "/timeline build": "Show the local case timeline.",
        "/timeline compare @a @b": "Compare the temporal activity of local profiles.",
        "/case create <title>": "Create a new local case.",
        "/case status": "Show case metrics.",
        ...
        "/confidence set relationship:<id> <0-1>": "Correct confidence for an evidence-backed edge.",
        "/contradictions|duplicates|gaps": "Inspect local data quality.",
        "/agent status": "Show local processing stages.",
        "/history": "Show locally executed commands.",
        "/report generate --format pdf": "Download the PDF report.",
