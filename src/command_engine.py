...
class CommandEngine:
    ...
    HELP = {
        ...
        "/find accounts --query <text>": "Profile im aktuellen Fall suchen.",
        ...
        "/source add <url>": "Eine externe Quelle im aktiven Fall registrieren.",
        "/profile show|history|connections @handle": "Lokale Profil- und Belegdaten anzeigen.",
        "/profile activity|aliases @handle": "Lokale Aktivitaet oder dokumentierte Wechselhinweise anzeigen.",
        "/profile compare @a @b": "Zwei lokale Profile und ihre gemeinsamen Verbindungen vergleichen.",
        "/graph build|centrality|communities": "Fallnetzwerk lokal auswerten.",
        ...
        "/case create <title>": "Einen neuen lokalen Fall anlegen.",
        "/case status": "Fallkennzahlen anzeigen.",
        "/case note <text>": "Eine Notiz im aktiven Fall speichern.",
        "/case tag <label>": "Einen lokalen Falltag registrieren.",
        "/review queue": "Unbestaetigte Hypothesen und Profilwechsel anzeigen.",
        "/review approve|reject claim:<id>": "Eine Identitaetshypothese pruefen oder verwerfen.",
        ...
        "/export case --format json|pdf": "Vollstaendigen Fall exportieren.",
    }
